...
def p_program_with_variables(p):
    ...
    if log: print(''' program : variables_block statements ''')
    # p[0] = p[1]
    pass

def p_program(p):
    ''' program : statements '''
    if log: print(''' program : statements ''')
    # p[0] = p[1]
    pass
...
def p_variables_block(p):
    ...
    if log: print(''' variables_block : var LLAVE_ABRE variables_list LLAVE_CIERRA ''')
    pass

def p_variables_list_r(p):
    ''' variables_list : variables_list variable_declaration '''
    if log: print(''' variables_list : variables_list variable_declaration ''')
    pass

def p_variables_list(p):
    ''' variables_list : variable_declaration '''
    if log: print(''' variables_list : variable_declaration ''')
    pass

def p_variable_declaration(p):
    ''' variable_declaration : variable_type variables_names PUNTO_COMA '''
    if log: print(''' variable_declaration : variable_type variables_names PUNTO_COMA ''')
    pass
...
def p_variable_type_int(p):
    ''' variable_type : int '''
    if log: print(''' variable_type : int ''')
    pass

def p_variable_type_real(p):
    ''' variable_type : real '''
    if log: print(''' variable_type : real ''')
    pass

def p_variable_type_string(p):
    ''' variable_type : string '''
    if log: print(''' variable_type : string ''')
    pass

def p_variable_type_bool(p):
    ''' variable_type : bool '''
    if log: print(''' variable_type : bool ''')
    pass
...
def p_statements(p):
    ...
    if log: print(''' statements : statement ''')
    # p[0] = p[1]
    pass
    
def p_statements_r(p):
    ''' statements : statements statement '''
    if log: print(''' statements : statements statement ''')
    # p[0] = p[1] + p[2]
    pass

def p_statement_assignment(p):
    ''' statement : assignment_statement '''
    if log: print(''' statement : assignment_statement ''')
    # p[0] = p[1]
    pass

def p_statement_select(p):
    ''' statement : select_statement '''
    if log: print(''' statement : select_statement ''')
    # p[0] = p[1]
    pass

def p_statement_while(p):
    ''' statement : while_statement '''
    if log: print(''' statement : while_statement ''')
    # p[0] = p[1]
    pass

def p_statement_in(p):
    ''' statement : in_statement '''
    if log: print(''' statement : in_statement ''')
    # p[0] = p[1]
    pass

def p_statement_out(p):
    ''' statement : out_statement '''
    if log: print(''' statement : out_statement ''')
    # p[0] = p[1]
    pass
...
def p_select_statement(p):
    ...
    if log: print(''' select_statement : if_statement ''')
    pass
...
def p_else_if_statement(p):
    ...
    if log: print(''' else_if_statement : else if_statement ''')
    pass

def p_else_if_statement_r(p):
    ''' else_if_statement : else_if_statement else if_statement '''
    if log: print(''' else_if_statement : else_if_statement else if_statement ''')
    pass

def p_else_if_statement_r_with_else(p):
    ''' else_if_statement : else_if_statement else_statement '''
    if log: print(''' else_if_statement : else_if_statement else_statement ''')
    pass

def p_else_statement(p):
    ''' else_statement : else LLAVE_ABRE statements LLAVE_CIERRA '''
    if log: print(''' else_statement : else LLAVE_ABRE statements LLAVE_CIERRA ''')
    pass
...
def p_op_logic_or(p):
    ''' op_logic : OP_OR '''
    if log: print(''' op_logic : OP_OR ''')
    pass

def p_op_logic_and(p):
    ''' op_logic : OP_AND '''
    if log: print(''' op_logic : OP_AND ''')
    pass

### ----------------------------------- Logical Constants
def p_cte_logic_true(p):
    ''' cte_logic : true '''
    if log: print(''' cte_logic : true ''')
    pass

def p_cte_logic_false(p):
    ''' cte_logic : false '''
    if log: print(''' cte_logic : false ''')
    pass
